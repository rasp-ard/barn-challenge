...
def generate_launch_description():
    ...
    # Launch Follow The Gap after 15 seconds
    ftg_stack = TimerAction(
        period=15.0,
        actions=[LogInfo(msg=">>>>>>>>> Launching Follow The Gap..."),
                 Node(package='jackal_helper', executable='follow_the_gap.py', output='screen')]
    )
