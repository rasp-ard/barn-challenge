...
def generate_launch_description():
    ...
    # Launch APF after 15 seconds
    apf_stack = TimerAction(
        period=15.0,
        actions=[LogInfo(msg=">>>>>>>>> Launching APF Planner..."),
                 Node(package='jackal_helper', executable='apf_planner.py', output='screen', parameters=[{'world_idx': LaunchConfiguration('world_idx')}])]
    )
