...
def generate_launch_description():
    ...
    launch_arg_imu_filter = DeclareLaunchArgument(
        'imu_filter',
        default_value='/home/raspard/barn_chall/src/The-Barn-Challenge-Ros2/jackal_helper/config/platform/config/imu_filter.yaml',
        description='')
        ...
        launch_arguments=
            [
                (
                    'setup_path'
                    ,
                    '/home/raspard/barn_chall/src/The-Barn-Challenge-Ros2/jackal_helper/config'
                )
                ,
                (
                    'use_sim_time'
            ...
            [
                {
                    'use_sim_time': True
                    ,
                    'config_file': '/home/raspard/barn_chall/src/The-Barn-Challenge-Ros2/jackal_helper/config/sensors/config/imu_0.yaml'
                    ,
                }
                ,
            ]
            ...
            [
                {
                    'use_sim_time': True
                    ,
                    'config_file': '/home/raspard/barn_chall/src/The-Barn-Challenge-Ros2/jackal_helper/config/sensors/config/gps_0.yaml'
                    ,
                }
                ,
            ]
